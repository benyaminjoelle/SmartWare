...
class PrefHelper {
  ...
  static Future<void> saveToken(String token) async {
    ...
    print(
      '✅ Token saved correctly: ${savedToken == token}',
    );
    print('═══════════════════════════');
  }
...
static Future<Map<String, dynamic>?> getUserData() async {
  ...
  static Future<void> saveBusinessType(
    String businessType,
  ) async {
    final prefs = await SharedPreferences.getInstance();
    ...
    print(
      '💾 Business type saved: $businessType',
    );
  }
  ...
  static Future<void> saveBusinessCategories(
    ...
    print(
      '💾 Business categories saved: $categories',
    );
  }
  ...
  static Future<void> clearClientOnboarding() async {
    ...
    print('🧹 Client onboarding cleared.');
  }
  ...
  static Future<void> saveOwnerProductCategories(
    ...
    print(
      '💾 Owner product categories saved: $categories',
    );
  }

  static Future<List<Map<String, dynamic>>>
      getOwnerProductCategories() async {
    final prefs = await SharedPreferences.getInstance();
    ...
    try {
      ...
      print(
        '❌ Failed to decode owner product categories: $e',
      );
  ...
  static Future<void> clearOwnerOnboarding() async {
    ...
    await prefs.remove(_ownerBusinessCategories);
    await prefs.remove(_ownerProductCategories);

    print('🧹 Owner onboarding cleared.');
  }

  // ============================================================
  // CLEAR EVERYTHING RELATED TO CURRENT USER
  // ============================================================
  ...
  static Future<void> clearUser() async {
    ...
    print('✅ Client onboarding cleared.');
    print('✅ Owner onboarding cleared.');
    print('✅ Owner categories cleared.');
    print('✅ Facility IDs cleared.');
    print('✅ Completion flags cleared.');
  ...
  static Future<void> debugUserData() async {
    ...
    print(
      '🏪 Business Type: '
      '${prefs.getString(_businessTypeKey)}',
    );

    print(
      '📦 Categories: '
      '${prefs.getStringList(_businessCategoriesKey)}',
    );
    ...
    print(
      'Step: ${prefs.getInt(_clientOnboardingStep)}',
    );

    print(
      'Completion: '
      '${prefs.getInt(_clientProfileCompletion)}',
    );

    print(
      'Preferences: '
      '${prefs.getBool(_clientPreferencesCompleted)}',
    );

    print(
      'Documents: '
      '${prefs.getBool(_clientDocumentsCompleted)}',
    );

    print(
      'Profile: '
      '${prefs.getBool(_clientProfileCompleted)}',
    );

    print(
      'Facility ID: '
      '${prefs.getInt(_clientFacilityId)}',
    );

    print(
      'Business Name: '
      '${prefs.getString(_clientBusinessName)}',
    );

    print(
      'Business Type: '
      '${prefs.getString(_clientBusinessType)}',
    );

    print(
      'Selected Products: '
      '${prefs.getStringList(_clientSelectedProducts)}',
    );
    ...
    print('');
    print('──── OWNER ONBOARDING ────');

    print(
      'Step: ${prefs.getInt(_ownerOnboardingStep)}',
    );

    print(
      'Completion: '
      '${prefs.getInt(_ownerProfileCompletion)}',
    );

    print(
      'Preferences: '
      '${prefs.getBool(_ownerPreferencesCompleted)}',
    );

    print(
      'Documents: '
      '${prefs.getBool(_ownerDocumentsCompleted)}',
    );

    print(
      'Profile: '
      '${prefs.getBool(_ownerProfileCompleted)}',
    );

    print(
      'Facility ID: '
      '${prefs.getInt(_ownerFacilityId)}',
    );

    print(
      'Business Name: '
      '${prefs.getString(_ownerBusinessName)}',
    );

    print(
      'Business Type: '
      '${prefs.getString(_ownerBusinessType)}',
    );

    print(
      'Selected Products: '
      '${prefs.getStringList(_ownerSelectedProducts)}',
    );

    print(
      'Business Categories: '
      '${prefs.getStringList(_ownerBusinessCategories)}',
    );

    print(
      'Product Categories: '
      '${prefs.getString(_ownerProductCategories)}',
    );
