...
class ProductsRepo {
  ...
  Future<List<OwnerInventoryModel>> getWarehouseInventory({
    ...
    try {
      ...
      if (items is! List) {
        throw ApiError(
          message: 'Invalid inventory list',
        );
      }
      ...
      print(
        '📦 Total Inventory Items: ${result.length}',
      );
  ...
  Future<CreateProductResponse> createProduct({
    ...
    try {
      ...
      final result =
          CreateProductResponse.fromJson(response);
