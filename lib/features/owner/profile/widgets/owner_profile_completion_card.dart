...
import 'package:smartware/features/owner/profile/controllers/owner_profile_card_animation_controller.dart';
import 'package:smartware/features/owner/profile/controllers/owner_profile_complition_controller.dart';
import 'package:smartware/features/owner/profile/views/owner_profile_completion_view.dart';



class OwnerProfileCompletionCard extends StatelessWidget {
  const OwnerProfileCompletionCard({super.key});

  @override
  Widget build(BuildContext context) {
    // Inject/Find the required controllers
    final animController = Get.put(OwnerProfileCardAnimationController());
    final profileController = Get.put(OwnerProfileComplitionController());
          ...
          child: ClipRRect(
            ...
            child: Material(
              ...
              child: InkWell(
                ...
                onTap: () {
                  if (!isComplete) {
                    Get.to(() => const OwnerProfileCompletionView());
                  }
                },
