...
class OwnerLocation extends StatelessWidget {
  ...
  final OwnerLocationController controller =
  ...
  Widget build(BuildContext context) {
    ...
    final double maxSuggestionHeight =
        (screenSize.height * 0.40).clamp(160.0, 280.0);
            ...
            () {
              return GoogleMap(
                ...
                initialCameraPosition:
                    OwnerLocationController.initialCameraPosition,
